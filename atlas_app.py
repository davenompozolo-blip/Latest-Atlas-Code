#!/usr/bin/env python3
"""
ATLAS TERMINAL v9.8 ULTIMATE EDITION
Complete Portfolio Analytics + Valuation House - Production Ready

🚀 NEW IN v9.8 (Latest Release - November 2025):
...
✅ Skill-Based Recommendations: Actionable insights for portfolio strategy
...
# ============================================================================
st.set_page_config(
    page_title="ATLAS Terminal v9.8 ULTIMATE",
    page_icon="🚀",
    layout="wide",
...
<style>
    ...
    * {{
    ...
    /* ========================================================================
       NUCLEAR FIX: Table Dropdown Menu Bug - Hide ALL broken UI elements
       ======================================================================== */

    /* Hide the three-dot menu on dataframes */
    ...
    /* Hide column configuration menu and popovers */
    ...
    /* Prevent any dropdown from rendering */
    [role="menu"],
    [role="listbox"],
    [data-baseweb="select"] {{
        display: none !important;
    ...
    /* Force clean table rendering - no overflow issues */
    div[data-testid="stDataFrame"] {{
        overflow: visible !important;
    }}

    /* Ensure table headers remain clean and properly styled */
    div[data-testid="stDataFrame"] thead th {{
        background: linear-gradient(135deg, {COLORS['neon_blue']} 0%, {COLORS['electric_blue']} 100%) !important;
    ...
    /* Clean up table body styling */
    div[data-testid="stDataFrame"] tbody td {{
        padding: 10px !important;
        border-bottom: 1px solid #1a3a52 !important;
    }}

    /* Hide any column sorting/filtering UI that might be garbled */
    div[data-testid="stDataFrame"] button {{
        display: none !important;
    }}

    /* Prevent column header interactions that trigger dropdowns */
    div[data-testid="stDataFrame"] thead th:hover {{
...
def main():
    st.markdown("<h1>🚀 ATLAS TERMINAL v9.8 ULTIMATE</h1>", unsafe_allow_html=True)
    ...
    st.markdown("<p style='text-align: center; color: #00ff88; font-size: 14px;'>📅 Release: November 16, 2025 | 🔥 Latest Version v9.8</p>", unsafe_allow_html=True)
    ...
    # ========================================================================
        ...
        with tab3:
            if metrics:
                ...
                st.dataframe(metrics_df, use_container_width=True, hide_index=True, height=600, column_config=None)
