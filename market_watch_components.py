...
def display_regime_banner():
    ...
    with col1:
        # FIGMA REDESIGN: Market Regime with accent dot (no gradient bar)
        regime_html = f"""<div style="
        ...
        ">
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem;">
                <div style="
                    ...
                    opacity: 0.8;
                    box-shadow: 0 0 10px {regime_color};
                "></div>
                <p style="
                    margin: 0;
                    font-size: 0.75rem;
                ...
                try:
                    ...
                    if success and prices and len(prices) > 1:
                        ...
                        if len(prices_filtered) > 1:
                            ...
                            fig.update_layout(
                                height=180,  # Increased further for better visibility
