...
// ----------------------------------------------------------------
// computeBrinsonAttribution — moved to src/lib/attributionEngine.js
// so PERF and Nexus beat 07 share one compute (same pattern as
// valuationEngine.js). Re-exported here so existing imports keep
// working.
// ----------------------------------------------------------------
export { computeBrinsonAttribution } from '../lib/attributionEngine.js';
